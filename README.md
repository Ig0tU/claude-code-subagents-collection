...
Our system now supports two LLM providers for enhanced flexibility and reliability:

### 1. **Gemini (Google AI)**
- Requires an API key from Google AI Studio
- High-performance cloud-based inference
- Automatic fallback to Ollama on failure
...
Create a `llm_config.json` file in your project root:
...
The system automatically falls back from Gemini to Ollama in case of:
